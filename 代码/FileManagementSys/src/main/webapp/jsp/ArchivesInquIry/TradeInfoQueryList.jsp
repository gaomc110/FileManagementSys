      ...
      <div class="layui-row">
	    <div class="layui-col-xs3 layui-col-md3">
	       <div class="layui-form-item">
	          <label class="layui-form-label">交易年份：</label>
	           <div class="layui-input-block">
				   <select name="dealDate" id="dealDate" lay-filter="" autocomplete="off">
					   <option value="" >请选择交易年份</option>
				   </select>
	           </div>
	       </div>
	    </div>
...
<!--列表-->
   <section class="panel panel-padding" style="margin-bottom:0;">
       <div class="group-button">
               <span class="tableheadtile">交易信息列表</span>
       </div>
...
<script type="text/javascript" src="js/TradeInfoQueryList.js"></script>
</body>
</html>