...
<div class="layui-tab-content container-fluid">
    ...
    <section class="panel panel-padding layui-form demouTable">
        <div class="layui-row">
            ...
            <div class="searchW layui-col-xs5 layui-col-md5">
                <div class="layui-form-item">
            ...
            <div class="layui-col-xs3 layui-col-md3">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="padding: 9px 0; width:96px;">操作人员账号</label>
                    <div class="layui-input-block">
        ...
        <div class="layui-row">
            <div class="layui-col-xs3 layui-col-md3">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="padding: 9px 0; width:96px;">操作人员姓名</label>
                    <div class="layui-input-block">
