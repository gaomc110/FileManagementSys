...
layui.use(['laypage', 'table', 'element', 'layer', 'jquery', 'form'], function (exports) {
    ...
    table.render({
        ...
        , url: getPath() + '/AuthorityController/getRoleList.do'
        , method: 'post'
        , page: true
        , id: 'iduTest'
        , limits: [10, 20, 50, 100]
        ...
        , cols: [[ //标题栏
            ...
            , {field: 'ROLENAME', title: '角色名称', minWidth: 135, align: 'center'}
            , {field: 'REMARKS', title: '角色描述', minWidth: 135, align: 'center'}
            , {field: '', title: '角色使用人员', minWidth: 100, align: 'center'}
