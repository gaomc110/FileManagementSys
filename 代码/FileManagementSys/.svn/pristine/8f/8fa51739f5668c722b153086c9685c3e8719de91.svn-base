...
public final class SM3Util {
     ...
     * @throws IOException
     */
    public static String encrypt(byte[] source) throws IOException {
        ...
        return new String(Hex.encodeHex((vi1)));
    }
    ...
    private static Integer FF(Integer x, Integer y, Integer z, int j) {
        if (j >= 0 && j <= 15) {
            ...
            return Integer.valueOf((x.intValue() & y.intValue()) | (x.intValue() & z.intValue()) | (y.intValue() & z.intValue()));
        } else {
            throw new RuntimeException("data invalid");
        }
    }
