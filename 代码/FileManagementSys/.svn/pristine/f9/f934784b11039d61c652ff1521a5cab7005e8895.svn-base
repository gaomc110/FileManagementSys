...
<div class="layui-tab-content container-fluid">
        ...
        <div class="layui-row">
            <div class="layui-col-xs3 layui-col-md3">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width:104px;">角色名称：</label>
                    <div class="layui-input-block" style="margin-left: 134px;">
                        <input class="layui-input" autocomplete="off" id="roleName" name="roleName"
                               placeholder="请输入角色名称">
                    </div>
                </div>
            </div>
    ...
    <section class="panel panel-padding" style="margin-bottom:0;">
        <div class="group-button" id="contentlisttile">
            <span class="tableheadtile">角色列表</span>
        </div>
