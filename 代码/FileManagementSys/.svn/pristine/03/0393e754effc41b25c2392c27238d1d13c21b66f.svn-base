	       ...
	       <div class="layui-form-item">
	          <label class="layui-form-label">小区名称：</label>
	           <div class="layui-input-block">
	               <input class="layui-input" autocomplete="off" id="unamekeyword" name="unamekeyword" placeholder="请输入小区名称">
	           </div>
	       </div>    
	    </div>
	      ...
	      <div class="layui-form-item">
	          <label class="layui-form-label" style="width:114px;">房屋坐落地址：</label>
	           <div class="layui-input-block" style="margin-left: 144px;">
	               <input class="layui-input" autocomplete="off" id="unamekeyword" name="unamekeyword" placeholder="请输入房屋坐落地址">
	           </div>
	       </div> 
	    </div>
	    <div class="layui-col-xs3 layui-col-md3">
	      <div class="layui-form-item">
	          <label class="layui-form-label">丘权号：</label>
	           <div class="layui-input-block">
	               <input class="layui-input" autocomplete="off" id="unamekeyword" name="unamekeyword" placeholder="请输入丘权号">
	           </div>
	       </div> 
	    </div>
	  </div>
	    ...
	    <div class="layui-col-xs3 layui-col-md3">
	       <div class="layui-form-item">
	          <label class="layui-form-label">产权人：</label>
	           <div class="layui-input-block">
	               <input class="layui-input" autocomplete="off" id="unamekeyword" name="unamekeyword" placeholder="请输入产权人">
	           </div>
	       </div>    
	    </div>
	    <div class="layui-col-xs6 layui-col-md6">
...
<!--列表-->
   <section class="panel panel-padding" style="margin-bottom:0;">
       <div class="group-button">
               <span class="tableheadtile">档案录入列表</span>
...
<script type="text/javascript" src="js/AInfoInputList.js"></script>
</body>
</html>